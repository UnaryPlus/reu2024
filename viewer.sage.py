...
_sage_const_4 = Integer(4); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_5 = Integer(5); _sage_const_1p0001 = RealNumber('1.0001'); _sage_const_40 = Integer(40); _sage_const_0p5 = RealNumber('0.5')
...
spheres = [ sphere(_sage_const_3 , pi/_sage_const_2 , _sage_const_5 *pi/_sage_const_4 , _sage_const_1 ), sphere(_sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_1p0001 ) ]
